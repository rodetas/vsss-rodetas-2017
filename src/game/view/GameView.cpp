...
int GameView::GUI() {
    ...
    Glib::RefPtr<Gtk::Builder> builder = Gtk::Builder::create_from_file("game/view/Game.glade");
    ...
    control_connection = Glib::signal_timeout().connect(sigc::mem_fun(game_model, &GameModel::control), 33, Glib::PRIORITY_DEFAULT_IDLE);     
